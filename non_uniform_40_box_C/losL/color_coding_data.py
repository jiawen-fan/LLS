...
test = []
#compare_integral
# change this for the code to run on high neutral fraction
# with open('cul_integral_high_neutral_fraction.pkl', 'rb') as f:
#     lyman_limited_value = pickle.load(f)
with open('.pkl', 'rb') as f:
    lyman_limited_value = pickle.load(f)

test = np.array_split(lyman_limited_value, 2)

lymans= nfvir(test[1],4)
with open('color_data1_cul_integral_high_neutral_fraction.pkl', 'wb') as f:
